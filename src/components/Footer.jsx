  ...
  return (
    <footer className="bg-white rounded-lg">
      <div className="w-full max-w-screen-xl mx-auto p-4">
        <a
          href="/prikareirl/#/"
          className="flex justify-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse mx-auto"
        >
          <img src={props.logo} className="h-40" alt="Prikar Eirl" />
        </a>
        <div className="sm:flex sm:items-start sm:justify-between">
          <div>
            <a href={props.telefono}>
              <p className="text-gray-500">
                <span className="font-medium">Fono:</span> <br />
                +56 9 5839 1985
              </p>
            </a>
            <a href={props.telefono}>
              <p className="text-gray-500">+56 9 8182 9765</p>
            </a>
            <br />
            <p className="font-medium text-gray-500">Email: </p>
            <p className="text-gray-500">prikar.eirl@gmail.com</p>
            <p className="text-gray-500">
              construccionesprikar@gmail.com
            </p>
            <br />
            <br />
          </div>
